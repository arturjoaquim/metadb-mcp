---
name: architecture
description: Define as regras de arquitetura limpa (Clean Architecture), responsabilidades das camadas (infrastructure, application, interfaces, shared) e onde colocar cada tipo de arquivo no projeto MetaDB MCP. Use sempre que for criar novos módulos, classes ou refatorar a estrutura do projeto.
---
